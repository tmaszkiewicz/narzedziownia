...
urlpatterns = [
    ...
    url(r'^narzedzia_usun_alert/(?P<pk>\d+)/$', views.narzedzia_usun_alert,{},name="narzedzia_usun_alert"),
    ...
    url(r'^pracownicy_edit_arch/(?P<pk>\d+)/$', views.pracownicy_edit,{},name="pracownicy_edit_arch"),
    ...
    url(r'^notconfirmed/$', views.notconfirmed,name="notconfirmed"),
    url(r'^sign_test/$', views.sign_test,name="sign_test"),
    url(r'^canvas/$', views.canvas,name="canvas"),
    url(r'^zwolniony_alert/(?P<pk>\d+)/$', views.zwolniony_alert,{},name="zwolniony_alert"),
